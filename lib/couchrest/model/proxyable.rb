  ...
  module Model
    ...
    module Proxyable
      ...
      def proxy_database(suffix = nil)
        ...
        @proxy_database ||= self.class.prepare_database([self.send(self.class.proxy_database_method), suffix].compact.reject(&:blank?).join(self.class.connection[:join]), true)
      end
